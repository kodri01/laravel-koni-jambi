    ...
    <div class="shadow-sm p-3 mb-5 bg-white rounded">
        ...
        <form method="POST" action="{{route('roles.update',$role->id)}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" aria-describedby="name" placeholder="Peran" value="{{old('name',ucfirst($role->name))}}">
                @error('name')
