...
@section('content')
    <div class="container-fluid">
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            <h2>Edit Pelatih</h2>
            <form method="POST" action="{{ url('clubs/' . $club_id . '/pelatih/update/' . $pelatih->id) }}"
                ...
                <div class="button-grup">
                    <a href="{{ url('clubs/' . $club_id . '/pelatih') }}" class="btn btn-danger m-1">Back</a>
